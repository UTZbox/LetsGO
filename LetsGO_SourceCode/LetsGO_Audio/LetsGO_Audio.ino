/* LetsGO Cue controller and Stereo USB Audio Interface.
   Created by Mike Utz
   ...
   You must select Board: Teensy 3.2 and USB-Type Audio+Keyboard from the "Tools" menu for this code to compile.
