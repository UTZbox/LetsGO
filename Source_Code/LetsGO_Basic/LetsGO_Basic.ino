/* KeyGo Keyboard and MIDI Cue controller.
   Created by Mike Utz
   ...
   The Midi Mode switch is connected to input pin 17
   ...
   You must select Keyboard from the "Tools > USB Type" menu for this code to compile.

  
   History:
   Version 0.4.1 / Bug fixing not working timer SinceLastCue
...
void loop()
{
  ...
  for (int i = 0; i < NUM_OF_BUTTONS; i++)
  {
    ...
    if (buttons[i].risingEdge() and sinceLastCue >=25 )
    {
