/* LetsGO Cue controller. (Basic plus Version)
   Created by Mike Utz
   ...
   The Midi Mode switch is connected to input pin 9 + 10
   The USB-MIDI ON/OFF switch is connected to input pin 11
   The Cue Inputs are connected to input pins 2 - 5.
   The Outputs are connected to Pin 13 + 16 for RUN and 17 for Transmit LED.
...
void setup() {
  ...
  //Configure Mode Inputs // Last uesd Pin Nr: +1
  for (int i = 6; i < 13; i++) {
